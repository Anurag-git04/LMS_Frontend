...
const UpdateLeadPage = () => {
    ...
    const onsubmit = async(e)=>{
        ...
        try{
            ...
            console.log(newLead)
            const response = await fetch(`https://lms-backend-bay-eight.vercel.app/leads/${leadId}`,{
                method:'PUT',
                headers: {
            ...
            if(response.status == 200){
                alert(`Lead is updated succesfully`)
                navigate('/')
            }else{
  ...
  return (
    <div> 
        <h2 className='mainheading'> UPDATE LEAD </h2>
        <div className="box">
            <BackToDash/>
            <div className="formcss">
                <form onSubmit={onsubmit}>
                    <h3>Form for updating lead:</h3>
